...
# Form implementation generated from reading ui file '.\all_in_one.ui'
#
...
"color: rgb(231, 158, 79);")
        ...
        self.dayTxt_5 = QtWidgets.QLineEdit(self.page_3)
        self.dayTxt_5.setGeometry(QtCore.QRect(460, 80, 86, 29))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.dayTxt_5.setFont(font)
        self.dayTxt_5.setStyleSheet("color: rgb(231, 158, 79);")
        self.dayTxt_5.setObjectName("dayTxt_5")
...
"color: rgb(231, 158, 79);")
        ...
        self.comboBox_5.setGeometry(QtCore.QRect(286, 80, 141, 27))
        font = QtGui.QFont()
        font.setPointSize(14)
...
"color: rgb(231, 158, 79);")
        ...
        self.comboBox_5.addItem("")
        self.comboBox_5.addItem("")
        self.hourTxt_5 = QtWidgets.QLineEdit(self.page_3)
        self.hourTxt_5.setGeometry(QtCore.QRect(585, 80, 86, 29))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.hourTxt_5.setFont(font)
        self.hourTxt_5.setStyleSheet("color: rgb(231, 158, 79);")
        self.hourTxt_5.setObjectName("hourTxt_5")
        self.yearTxt_5 = QtWidgets.QLineEdit(self.page_3)
        self.yearTxt_5.setGeometry(QtCore.QRect(167, 80, 101, 29))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.yearTxt_5.setFont(font)
        self.yearTxt_5.setStyleSheet("color: rgb(231, 158, 79);")
        self.yearTxt_5.setObjectName("yearTxt_5")
...
"color: rgb(231, 158, 79);")
        ...
        self.minTxt_5 = QtWidgets.QLineEdit(self.page_3)
        self.minTxt_5.setGeometry(QtCore.QRect(721, 80, 87, 29))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.minTxt_5.setFont(font)
        self.minTxt_5.setStyleSheet("color: rgb(231, 158, 79);")
        self.minTxt_5.setObjectName("minTxt_5")
...
"And then, please push \"Add\" button."))
        ...
        self.comboBox_5.setItemText(0, _translate("all_in_one", "January"))
        self.comboBox_5.setItemText(1, _translate("all_in_one", "February"))
        self.comboBox_5.setItemText(2, _translate("all_in_one", "March"))
        self.comboBox_5.setItemText(3, _translate("all_in_one", "April"))
        self.comboBox_5.setItemText(4, _translate("all_in_one", "May"))
        self.comboBox_5.setItemText(5, _translate("all_in_one", "June"))
        self.comboBox_5.setItemText(6, _translate("all_in_one", "July"))
        self.comboBox_5.setItemText(7, _translate("all_in_one", "August"))
        self.comboBox_5.setItemText(8, _translate("all_in_one", "September"))
        self.comboBox_5.setItemText(9, _translate("all_in_one", "October"))
        self.comboBox_5.setItemText(10, _translate("all_in_one", "November"))
        self.comboBox_5.setItemText(11, _translate("all_in_one", "December"))
    ...
    def searchInAll(self):
        ...
        searcher = Node(self.a, int(self.y2), self.mo2, int(self.d2), int(self.h2), int(self.mn2), self.ev)
        x = Node(self.a, int(self.y), self.mo, int(self.d), int(self.h), int(self.mn), self.ev)
        print(self.l1.searchNode(searcher) == x)
